...
class CciEmeVwapStrategy(ABCStrategy):
    strategy_name = "cci_ema_vwap"
    ...
    def exit_signal(self, candles, day_candles=None):
        ...
        if last_order_status.ready_to_procceed and last_order_status.is_long \
                and (cci7[-1] >= 100 or is_loss or is_profit or vwap_trend is None):
