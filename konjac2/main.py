...
from konjac2.jobs.scanner import scan_crypto, trade_eur_usd
...
async def start_job():
    if settings.run_cron_job:
        ...
        scheduler.add_job(scan_crypto, CronTrigger.from_crontab("0 * * * *"))
        scheduler.add_job(trade_eur_usd, CronTrigger.from_crontab("1 * * * *"))
